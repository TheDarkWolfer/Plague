...
execute at @e[tag=plague_contagion] run scoreboard players add @a[distance=0..3] plague_contagion 1
...
execute as @e[nbt={ActiveEffects:[{Id:10}]}] run scoreboard players set @s plague_contagion 0
